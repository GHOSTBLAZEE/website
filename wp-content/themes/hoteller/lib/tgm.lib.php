...
function hoteller_require_plugins() {
    ...
    $plugins = array(
		...
		array(
			...
			'source'             => 'https://themegoods-assets.b-cdn.net/hoteller-elementor/hoteller-elementor-v3.8.4.zip',
			'required'           => true, 
			'version'            => '3.8.4',
		),
		array(
		...
		array(
			...
			'source'             => 'https://themegoods-assets.b-cdn.net/motopress-hotel-booking/motopress-hotel-booking-v4.4.zip',
			'required'  		 => true, 
			'version'            => '4.4',
		),
		array(
			...
			'source'             => 'https://themegoods-assets.b-cdn.net/mphb-request-payment/mphb-request-payment-v1.1.9.zip',
			'required'  		 => false, 
			'version'            => '1.1.9',
		),
		array(
			...
			'slug'      		 => 'mphb-invoices',
			'source'             => 'https://themegoods-assets.b-cdn.net/mphb-invoices/mphb-invoices-v1.2.3.zip',
			'required'  		 => false, 
			'version'            => '1.2.3',
		),
		array(
			...
			'source'             => 'https://themegoods-assets.b-cdn.net/mphb-woocommerce/mphb-woocommerce-v1.0.8.zip',
			'required'  		 => false, 
			'version'            => '1.0.8',
		),
		array(
			...
			'source'             => 'https://themegoods-assets.b-cdn.net/mphb-checkout-fields/mphb-checkout-fields-v1.0.5.zip',
			'required'  		 => false, 
			'version'            => '1.0.5',
		),
		array(
			...
			'slug'      		 => 'mphb-notifier',
			'source'             => 'https://themegoods-assets.b-cdn.net/mphb-notifier/mphb-notifier-v1.1.3.zip',
			'required'  		 => false, 
			'version'            => '1.1.3',
		),
		array(
		...
		array(
			...
			'source'             => 'https://themegoods-assets.b-cdn.net/mphb-multi-currency/mphb-multi-currency-v1.2.zip',
			'required'  		 => false, 
			'version'            => '1.2.0',
		),
		array(
			...
			'slug'      		 => 'mphb-reviews',
			'source'             => 'https://themegoods-assets.b-cdn.net/mphb-reviews/mphb-reviews-v1.2.6.zip',
			'required'  		 => false, 
			'version'            => '1.2.6',
		),
	    array(
