	...
	public function filter_control_args( $args, $wp_customize ) {
		if ( $args['settings'] === $this->args['settings'] ) {
			...
			$args['button_labels'] = wp_parse_args(
				$args['button_labels'],
				[
					'select'       => esc_html__( 'Select image', 'hoteller' ),
					'change'       => esc_html__( 'Change image', 'hoteller' ),
					'default'      => esc_html__( 'Default', 'hoteller' ),
					'remove'       => esc_html__( 'Remove', 'hoteller' ),
					'placeholder'  => esc_html__( 'No image selected', 'hoteller' ),
					'frame_title'  => esc_html__( 'Select image', 'hoteller' ),
					'frame_button' => esc_html__( 'Choose image', 'hoteller' ),
				]
			);
