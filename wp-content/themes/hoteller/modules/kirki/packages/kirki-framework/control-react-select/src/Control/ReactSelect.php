...
class ReactSelect extends Base {
	...
	public function to_json() {
		...
		$this->json['placeholder'] = ( $this->placeholder ) ? $this->placeholder : esc_html__( 'Select...', 'hoteller' );
		...
		$this->json['messages'] = [
			...
			'maxLimitReached' => sprintf( esc_html__( 'You can only select %s items', 'hoteller' ), $this->max_selection_number ),
		];
