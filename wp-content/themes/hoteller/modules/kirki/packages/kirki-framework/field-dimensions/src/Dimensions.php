...
class Dimensions extends Field {
	...
	public function init( $args = array() ) {
		...
		$labels = array(
			...
			'font-size'      => esc_html__( 'Font Size', 'hoteller' ),
			'font-weight'    => esc_html__( 'Font Weight', 'hoteller' ),
			'line-height'    => esc_html__( 'Line Height', 'hoteller' ),
			'font-style'     => esc_html__( 'Font Style', 'hoteller' ),
			'letter-spacing' => esc_html__( 'Letter Spacing', 'hoteller' ),
			'word-spacing'   => esc_html__( 'Word Spacing', 'hoteller' ),
			'top'            => esc_html__( 'Top', 'hoteller' ),
			'bottom'         => esc_html__( 'Bottom', 'hoteller' ),
			'left'           => esc_html__( 'Left', 'hoteller' ),
			'right'          => esc_html__( 'Right', 'hoteller' ),
			'center'         => esc_html__( 'Center', 'hoteller' ),
			'size'           => esc_html__( 'Size', 'hoteller' ),
			'spacing'        => esc_html__( 'Spacing', 'hoteller' ),
			'width'          => esc_html__( 'Width', 'hoteller' ),
			'height'         => esc_html__( 'Height', 'hoteller' ),
			'invalid-value'  => esc_html__( 'Invalid Value', 'hoteller' ),
		);
