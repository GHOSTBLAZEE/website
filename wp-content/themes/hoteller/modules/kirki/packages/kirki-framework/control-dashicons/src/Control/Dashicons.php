		...
		<div class="icons-wrapper">
			...
			<# } else { #>
				...
				var dashiconSections = {
					'admin-menu': '<?php esc_html_e( 'Admin Menu', 'hoteller' ); ?>',
					'welcome-screen': '<?php esc_html_e( 'Welcome Screen', 'hoteller' ); ?>',
					'post-formats': '<?php esc_html_e( 'Post Formats', 'hoteller' ); ?>',
					'media': '<?php esc_html_e( 'Media', 'hoteller' ); ?>',
					'image-editing': '<?php esc_html_e( 'Image Editing', 'hoteller' ); ?>',
					'tinymce': 'TinyMCE',
					'posts': '<?php esc_html_e( 'Posts', 'hoteller' ); ?>',
					'sorting': '<?php esc_html_e( 'Sorting', 'hoteller' ); ?>',
					'social': '<?php esc_html_e( 'Social', 'hoteller' ); ?>',
					'wordpress_org': 'WordPress',
					'products': '<?php esc_html_e( 'Products', 'hoteller' ); ?>',
					'taxonomies': '<?php esc_html_e( 'Taxonomies', 'hoteller' ); ?>',
					'widgets': '<?php esc_html_e( 'Widgets', 'hoteller' ); ?>',
					'notifications': '<?php esc_html_e( 'Notifications', 'hoteller' ); ?>',
					'misc': '<?php esc_html_e( 'Miscelaneous', 'hoteller' ); ?>'
				};
				#>
