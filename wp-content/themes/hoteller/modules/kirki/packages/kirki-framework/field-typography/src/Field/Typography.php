...
class Typography extends Field {
	...
	public function init( $args = [] ) {
		...
		self::$std_variants = [
			[
				'value' => 'regular',
				'label' => __( 'Regular', 'hoteller' ),
			],
			[
				'value' => 'italic',
				'label' => __( 'Italic', 'hoteller' ),
			],
			[
				'value' => '700',
				'label' => __( '700', 'hoteller' ),
			],
			[
				'value' => '700italic',
				'label' => __( '700 Italic', 'hoteller' ),
			],
		];
		...
		self::$complete_variants = [
			...
			[
				'value' => '100',
				'label' => __( '100', 'hoteller' ),
			],
			[
				'value' => '100italic',
				'label' => __( '100 Italic', 'hoteller' ),
			],
			[
				'value' => '200',
				'label' => __( '200', 'hoteller' ),
			],
			[
				'value' => '200italic',
				'label' => __( '200 Italic', 'hoteller' ),
			],
			[
				'value' => '300',
				'label' => __( '300', 'hoteller' ),
			],
			[
				'value' => '300italic',
				'label' => __( '300 Italic', 'hoteller' ),
			],
			[
				'value' => '500',
				'label' => __( '500', 'hoteller' ),
			],
			[
				'value' => '500italic',
				'label' => __( '500 Italic', 'hoteller' ),
			],
			[
				'value' => '600',
				'label' => __( '600', 'hoteller' ),
			],
			[
				'value' => '600italic',
				'label' => __( '600 Italic', 'hoteller' ),
			],
			[
				'value' => '700',
				'label' => __( '700', 'hoteller' ),
			...
			[
				'value' => '800',
				'label' => __( '800', 'hoteller' ),
			],
			[
				'value' => '800italic',
				'label' => __( '800 Italic', 'hoteller' ),
			],
			[
				'value' => '900',
				'label' => __( '900', 'hoteller' ),
			],
			[
				'value' => '900italic',
				'label' => __( '900 Italic', 'hoteller' ),
			],
		];
	...
	private function add_sub_fields( $args ) {
		...
		if ( isset( $args['default']['font-family'] ) ) {
			...
			new \Kirki\Field\ReactSelect(
				wp_parse_args(
					[
						'label'       => esc_html__( 'Font Family', 'hoteller' ),
						'description' => '',
			...
			new \Kirki\Field\ReactSelect(
				wp_parse_args(
					[
						'label'       => esc_html__( 'Font Variant', 'hoteller' ),
						'description' => '',
		...
		if ( $font_size_field_specified || $color_field_specified ) {
			$group = [
				'font-size' => [
					'type'         => 'dimension',
					'label'        => esc_html__( 'Font Size', 'hoteller' ),
					'is_specified' => $font_size_field_specified,
				],
				'color'     => [
					'type'         => 'react-colorful',
					'label'        => esc_html__( 'Font Color', 'hoteller' ),
		...
		if ( $text_align_field_specified || $text_transform_field_specified ) {
			$group = [
				'text-align'     => [
					'type'         => 'react-select',
					'label'        => esc_html__( 'Text Align', 'hoteller' ),
					'is_specified' => $text_align_field_specified,
					'choices'      => [
						'initial' => esc_html__( 'Initial', 'hoteller' ),
						'left'    => esc_html__( 'Left', 'hoteller' ),
						'center'  => esc_html__( 'Center', 'hoteller' ),
						'right'   => esc_html__( 'Right', 'hoteller' ),
						'justify' => esc_html__( 'Justify', 'hoteller' ),
					],
				],
				'text-transform' => [
					'type'         => 'react-select',
					'label'        => esc_html__( 'Text Transform', 'hoteller' ),
					'is_specified' => $text_transform_field_specified,
					'choices'      => [
						'none'       => esc_html__( 'None', 'hoteller' ),
						'capitalize' => esc_html__( 'Capitalize', 'hoteller' ),
						'uppercase'  => esc_html__( 'Uppercase', 'hoteller' ),
						'lowercase'  => esc_html__( 'Lowercase', 'hoteller' ),
					],
				],
			];
		...
		if ( $text_decoration_field_specified ) {
			$group = [
				'text-decoration' => [
					'type'         => 'react-select',
					'label'        => esc_html__( 'Text Decoration', 'hoteller' ),
					'is_specified' => $text_decoration_field_specified,
					'choices'      => [
						'none'         => esc_html__( 'None', 'hoteller' ),
						'underline'    => esc_html__( 'Underline', 'hoteller' ),
						'line-through' => esc_html__( 'Line Through', 'hoteller' ),
						'overline'     => esc_html__( 'Overline', 'hoteller' ),
						'solid'        => esc_html__( 'Solid', 'hoteller' ),
						'wavy'         => esc_html__( 'Wavy', 'hoteller' ),
					],
				],
			];
		...
		if ( $line_height_field_specified || $letter_spacing_field_specified ) {
			$group = [
				'line-height'    => [
					'type'         => 'dimension',
					'label'        => esc_html__( 'Line Height', 'hoteller' ),
					'is_specified' => $line_height_field_specified,
				],
				'letter-spacing' => [
					'type'         => 'dimension',
					'label'        => esc_html__( 'Letter Spacing', 'hoteller' ),
		...
		if ( $margin_top_field_specified || $margin_bottom_field_specified ) {
			$group = [
				'margin-top'    => [
					'type'         => 'dimension',
					'label'        => esc_html__( 'Margin Top', 'hoteller' ),
					'is_specified' => $margin_top_field_specified,
				],
				'margin-bottom' => [
					'type'         => 'dimension',
					'label'        => esc_html__( 'Margin Bottom', 'hoteller' ),
	...
	private function get_font_family_choices() {
		...
		$choices['default'] = [
			esc_html__( 'Defaults', 'hoteller' ),
			[
				'' => esc_html__( 'Default', 'hoteller' ),
			],
		];
		...
		$choices['standard'] = [
			esc_html__( 'Standard Fonts', 'hoteller' ),
			$std_fonts,
		];

		$choices['google'] = [
			esc_html__( 'Google Fonts', 'hoteller' ),
