...
class BookingsCalendar {
	...
	private function renderPseudoCell( $roomId, $date ){
		...
		$isCurrentBookingPending = in_array( $dateDetails['booking_status'], $bookingPendingStatuses );
		$isPreviousBookingPending = in_array( $dateDetails['check_out_booking_status'], $bookingPendingStatuses );
