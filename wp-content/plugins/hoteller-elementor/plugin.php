...
class Hoteller_Elementor {
	...
	private function register_widget() {
		...
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Hoteller_Accommodation_Carousel() );
		...
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Hoteller_Animated_Text() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Hoteller_Animated_Headline() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Hoteller_Service_Grid() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Hoteller_Service_Carousel() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Hoteller_Testimonial_Carousel() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Hoteller_Testimonial_Slider() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Hoteller_Food_Menu() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Hoteller_Portfolio_Timeline() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Hoteller_Contact_Form() );
	}
